...
"""Test for create_pascal_tf_record_bak.py."""
...
from object_detection.dataset_tools import create_pascal_tf_record_bak
...
class CreatePascalTFRecordTest(tf.test.TestCase):
  ...
  def test_dict_to_tf_example(self):
    ...
    example = create_pascal_tf_record_bak.dict_to_tf_example(
