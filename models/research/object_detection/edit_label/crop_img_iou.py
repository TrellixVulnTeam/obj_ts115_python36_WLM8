...
resize_shape = 0.5
# 原始img文件夹路径
# img_path = "/home/db/图片/5720飞机上半部分标签及原图_20200420/wen"
img_path = "/home/db/图片/temp/test"
# 保存新生成的img文件夹路径
result_path_img = "/home/db/图片/temp/test_c/"
# 裁剪的大小
crop_size = (640, 640)
# 重合的边界
border = 90
...
box_iou = 0.8
# 原始xml文件夹路径
xml_path = "/home/db/图片/temp/test_xml"
# xml_path = "/home/db/PycharmProjects/num_seven/file_test/src_xml/20200414_141751.xml"
# 保存新生成的xml文件夹路径
result_path_xml = "/home/db/图片/temp/test_xml_c/"
...
class CropImageLabel():
    ...
    def __init__(self, img_path, xml_path, result_path_img, result_path_xml, crop_size, border, resize_shape):
            ...
            for y_l in range(w_num):
                ...
                for point in points_list:
                    if ((point[0] > y_min and point[0] < y_max) and (point[1] > x_min and point[1] < x_max)) or ((
                            point[2] > y_min and point[2] < y_max) and (
                            point[3] > x_min and point[3] < x_max)):
                ...
                self.creat_xml(img_result_path, xml_img_path, point_one_list, img_result)
...
if __name__ == "__main__":
    ...
    for root, folders, files in os.walk(img_path):
        ...
        for file in files:
            ...
            # print(img_path_one)
            # print(xml_path_one)
            crop_image_label = CropImageLabel(img_path_one, xml_path_one, result_path_img, result_path_xml, crop_size,
                                              border, resize_shape)
            crop_image_label.crop_img(box_iou)
            index += 1
