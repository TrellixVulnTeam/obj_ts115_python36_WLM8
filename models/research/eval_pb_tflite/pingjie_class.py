...
class CJPJ():
    def __init__(self, img, crop_size, border, show_rate):
    ...
    def crop_img(self, img):
        ...
        img = cv2.copyMakeBorder(self.img, 0, self.h_num * self.crop_size[0] + self.border - h, 0,
    ...
    def get_box_list(self, croped_img_list, show_rate):
...
if __name__ == '__main__':
    ...
    cjpj = CJPJ(img_data, crop_size, border, show_rate)
    croped_img_list = cjpj.crop_img(img_data)
    img11 = cjpj.get_box_list(croped_img_list, show_rate)
